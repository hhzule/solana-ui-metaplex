  ...
  return (
        ...
        <div className='flex justify-between items-center  md:flex md:items-center'>
            ...
            <div className=''>
                ...
                <li className='mr-4 ml-4 xs:py-[2px] cursor-pointer'><Link to="/Presale">Presale</Link></li>
                <li className='mr-4 ml-4 xs:py-[2px] cursor-pointer'><Link to="/Team">Team</Link></li>
                </ul>
                </div>
