...
const Header = () => {
  ...
  return (
        <div className=' flex justify-around w-100 lg:pl-20 lg:pr-20 md:pl-20 md:pr-20 sm:flex sm:justify-around md:flex md:justify-evenly lg:justify-evenly bg-bgdark py-4  border-b border-gray-600 '>
