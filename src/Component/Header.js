...
const Header = () => {
  ...
  return (
        ...
        <div className='flex justify-between items-center  md:flex md:items-center'>
            ...
            <div className=''>
                <ul className={isOpen?" xs:bg-white xs:w-[180px] z-50 xs:fixed  xs:mr-[90px]  sm:w-[180px] xs:px-2  xs:mt-4 xs:py-6 xs:right-0  sm:fixed sm:bg-white sm:py-4   sm:mt-4  sm:right-0  sm:mr-[140px] sm:ml-[350px] md:ml-[100px] rounded md:bg-bgdark md:mt-[0px] md:items-center md:py-0 sm:text-left md:flex lg:flex md:text-white text-sm  uppercase  font-semibold pl-6 pr-6":'hidden sm:ml-[85px] md:ml-[200px] rounded  sm:text-left md:flex lg:flex lg:ml-0  md:text-white text-sm  uppercase  font-semibold pl-6 pr-6' }
                >
                <li className='mr-4 ml-4 xs:pt-[2px] xs:hover:text-bggreen xs:cursor-pointer cursor-pointer'>launchpad</li>
                <li className='mr-4 ml-4 xs:py-[2px] cursor-pointer'>Game World</li>
                <li className='mr-4 ml-4 xs:py-[2px] cursor-pointer'>Others</li>
                </ul>
                </div>
