...
const Herosection = () => {
  return (
    <div className='w-100 h-auto md:flex'>
       ...
       <a href='http://brdigitech.com/' target='_blank'> <button className='w-[170px] h-12 bg-bggreen hover:bg-hoverBg text-center font-semibold rounded-sm '>Luanchpad </button></a> 
       <a href='http://brdigitech.com/' target='_blank'> <button className='w-[170px] h-12 rounded-sm	border border-gray-600 text-white hover:bg-white hover:text-black hover:font-semibold'>Find The Gems</button> </a>
