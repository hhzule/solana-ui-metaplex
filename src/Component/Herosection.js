...
const Herosection = () => {
  return (
    <div className='w-100 h-auto md:flex'>
        ...
        <div className='hidden md:flex md:gap-4 md:absolute md:top-0 md:mt-[380px] md:ml-[180px]' >
        ...
        <div className='flex flex-1 flex-col items-center justify-center bg-[#0E1524] md:gap-1 md:rounded-[8px] md:py-[10px] xl:gap-2 xl:rounded-[10px] xl:py-[12px] 2xl:gap-3 2xl:py-[14px] 2xxl:gap-3 2xxl:rounded-xl 2xxl:py-[16px]'>

    
         <p className='text-xl text-white font-extrabold'>80+</p>
         <p className='text-sm text-gray-400'>Project Launched</p>
         </div>
            </div>
        ...
        <div className='flex flex-1 flex-col items-center justify-center bg-[#0E1524] md:gap-1 md:rounded-[8px] md:py-[10px] xl:gap-2 xl:rounded-[10px] xl:py-[12px] 2xl:gap-3 2xl:py-[14px] 2xxl:gap-3 2xxl:rounded-xl 2xxl:py-[16px]'>
         ...
         <p className=' text-sm text-gray-400'>ATH Avg Roi</p>
            ...
            <div className='w-[9.609375vw] 2xxl:w-[185px] overflow-hidden bg-gradient-to-b from-[#616D85] to-[#1E294200] mds:rounded-[8px] mds:p-[2px] xl:rounded-[10px] xl:p-[2px] 2xxl:rounded-xl 2xxl:p-[3px]'>
            <div className='flex flex-1 flex-col items-center justify-center bg-[#0E1524] mds:gap-1 mds:rounded-[8px] mds:py-[10px] xl:gap-2 xl:rounded-[10px] xl:py-[12px] 2xl:gap-3 2xl:py-[14px] 2xxl:gap-3 2xxl:rounded-xl 2xxl:py-[16px]'>
       ...
       <div className=' flex absolute top-0 mt-[680px] ml-[65px] gap-3 md:flex md:absolute md:top-0 md:mt-[540px] md:ml-[180px] md:gap-4'>
