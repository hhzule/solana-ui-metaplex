...
const mission = ({image, text}) => {
  return (
    
        <div className='col-span-1 my-4 ml-4 flex h-[226px] w-[200px] flex-col gap-[16px] rounded-xl border-[1px] border-[#5B5B5B] bg-black p-[16px] hover:drop-shadow-[0px_0px_10px_rgba(255,255,255)] md:my-0 md:ml-0 md:h-[200px] md:w-[13.02vw] md:gap-[8px] mds:p-[8px] lg:gap-[12px] lg:p-[10px] xl:gap-[18px] xl:p-[12px] 2xl:gap-[18px] 2xl:p-[12px] 2xxl:gap-[24px] 2xxl:p-[16px] 2xxl:w-[250px]'>
