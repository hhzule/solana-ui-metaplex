...
const Team = () => {
  return (
    <div className="w-[80%] my-24 mx-auto md:px-6">
   
    <section className="mb-32 text-center">
      <h2 className="mb-12 text-3xl font-bold text-white">
        Meet the <u className="text-primary dark:text-white">team</u>
      </h2>
              ...
              <ul className="mx-auto flex list-inside justify-center">
                <a href="#!" className="px-2">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                    className="h-4 w-4 text-primary text-white">
                    <path fill="currentColor"
                ...
                <a href="#!" className="px-2">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                    className="h-3.5 w-3.5 text-primary text-white">
                    <path fill="currentColor"
        ...
        <div className="mb-6 lg:mb-0">
          <div
            ...
            <div className="relative overflow-hidden bg-cover bg-no-repeat">
              ...
              <svg className="absolute text-white dark:text-neutral-700  left-0 bottom-0"
            ...
            <div className="p-6">
              ...
              <ul className="mx-auto flex list-inside justify-center">
                <a href="#!" className="px-2">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-primary text-white"
